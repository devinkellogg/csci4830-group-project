...
class SimpleFormDeleteSpec {
	...
	void testIdNotFound() throws Exception {
		...
		Mockito.doReturn("test").when(request).getParameter("deleteID");
		
		SimpleFormDelete sfd = new SimpleFormDelete();
		SimpleFormDelete sfd1 = Mockito.spy(sfd);
		
		Mockito.doReturn(false).when(sfd1).dbHelper("test");
		sfd1.doGet(request, response);
		Mockito.verify(out).println("<html>\r\n" + 
	      		...
	      		"\r\n" + 
	      		"<section>\r\n" + 
	      		"<h2 align=\"center\">Nothing with the given ID was found!</h2>\n" + //
	      		"</section>\r\n" + 
	      		"\r\n" + 
	      		"<footer>\r\n" + 
	...
	@Test
	void testIdFound() throws Exception {
		PrintWriter out = Mockito.mock(PrintWriter.class);
		...
		HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
		Mockito.when(request.getParameter("deleteID")).thenReturn("test");
		
		SimpleFormDelete sfd = new SimpleFormDelete();
		SimpleFormDelete sfd1 = Mockito.spy(sfd);
		
		Mockito.doReturn(true).when(sfd1).dbHelper("test");
		sfd1.doGet(request, response);
		Mockito.verify(out).println("<html>\r\n" + 
	      		"<head>\r\n" + 
	      		"<style>\r\n" + 
	      		...
	      		"\r\n" + 
	      		"<section>\r\n" + 
	      		"<h2 align=\"center\">Deletion was successful!</h2>\n" + //
	      		"</section>\r\n" + 
	      		"\r\n" + 
	      		"<footer>\r\n" + 
	      		"Food Tracker site created by Devin Kellogg, Logan Sortino, Conner Kennell, and Ben Jahnke\r\n" + 
